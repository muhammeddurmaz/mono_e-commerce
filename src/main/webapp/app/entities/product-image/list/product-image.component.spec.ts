...
describe('ProductImage Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'product-image', component: ProductImageComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.productImages?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to productImageService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProductImageIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProductImageIdentifier).toHaveBeenCalledWith(entity);
