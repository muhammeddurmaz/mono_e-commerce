...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../favorite.test-samples';
...
describe('Favorite Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Favorite', () => {
      ...
      service.create(favorite).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Favorite', () => {
      ...
      service.update(favorite).subscribe(resp => (expectedResult = resp.body));
