...
describe('ProductInventory Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'product-inventory', component: ProductInventoryComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.productInventories?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to productInventoryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProductInventoryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProductInventoryIdentifier).toHaveBeenCalledWith(entity);
