...
describe('ProductModel Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'product-model', component: ProductModelComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.productModels?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to productModelService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProductModelIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProductModelIdentifier).toHaveBeenCalledWith(entity);
