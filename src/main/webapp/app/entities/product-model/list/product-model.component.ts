...
import { EntityArrayResponseType, ProductModelService } from '../service/product-model.service';
...
export class ProductModelComponent implements OnInit {
  ...
  trackId = (_index: number, item: IProductModel): number => this.productModelService.getProductModelIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.productModels = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IProductModel[] | null): IProductModel[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.productModelService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
