...
public interface PaymentRepository extends JpaRepository<Payment, Long> {
    ...
    @Query(
        value = "select distinct payment from Payment payment left join fetch payment.user",
    ...
    @Query("select distinct payment from Payment payment left join fetch payment.user")
