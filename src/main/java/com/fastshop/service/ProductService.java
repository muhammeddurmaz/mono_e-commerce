...
/**
 * Service Interface for managing {@link com.fastshop.domain.Product}.
 */
public interface ProductService {
    ...
    /**
     * Get all the ProductDTO where ProductStatistics is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<ProductDTO> findAllWhereProductStatisticsIsNull();
