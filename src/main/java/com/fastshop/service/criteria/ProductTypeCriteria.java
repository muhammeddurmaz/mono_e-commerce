...
/**
 * Criteria class for the {@link com.fastshop.domain.ProductType} entity. This class is used
 * in {@link com.fastshop.web.rest.ProductTypeResource} to receive all the possible filtering options from
...
public class ProductTypeCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, categoryId, distinct);
    }
