...
/**
 * Service Interface for managing {@link com.fastshop.domain.Seller}.
 */
public interface SellerService {
    ...
    /**
     * Get all the SellerDTO where Brand is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<SellerDTO> findAllWhereBrandIsNull();
    /**
     * Get all the SellerDTO where SellerStatistics is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<SellerDTO> findAllWhereSellerStatisticsIsNull();
    ...
    /**
     * Search for the seller corresponding to the query.
     *
     ...
     * @return the list of entities.
     */
    Page<SellerDTO> search(String query, Pageable pageable);
}
