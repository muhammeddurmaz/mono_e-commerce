...
import com.fastshop.service.ProductTypeQueryService;
...
/**
 * REST controller for managing {@link com.fastshop.domain.ProductType}.
 */
@RestController
@RequestMapping("/api")
public class ProductTypeResource {
    ...
    public ResponseEntity<List<ProductTypeDTO>> searchProductTypes(
