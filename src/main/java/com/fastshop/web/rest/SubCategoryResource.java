...
import com.fastshop.service.SubCategoryQueryService;
...
/**
 * REST controller for managing {@link com.fastshop.domain.SubCategory}.
 */
@RestController
@RequestMapping("/api")
public class SubCategoryResource {
    ...
    public ResponseEntity<List<SubCategoryDTO>> searchSubCategories(
        ...
        Page<SubCategoryDTO> page = subCategoryService.search(query, pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
        return ResponseEntity.ok().headers(headers).body(page.getContent());
    }
}
