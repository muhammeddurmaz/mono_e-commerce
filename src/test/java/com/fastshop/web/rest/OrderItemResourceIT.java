...
import com.fastshop.domain.enumeration.OrderItemStatus;
import com.fastshop.repository.OrderItemRepository;
import com.fastshop.service.dto.OrderItemDTO;
import com.fastshop.service.mapper.OrderItemMapper;
...
class OrderItemResourceIT {
    ...
    private static final OrderItemStatus DEFAULT_STATUS = OrderItemStatus.PENDING;
    private static final OrderItemStatus UPDATED_STATUS = OrderItemStatus.PREPARING;
