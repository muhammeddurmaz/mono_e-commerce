...
class PaymentResourceIT {
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().placedDate(DEFAULT_PLACED_DATE).quantity(DEFAULT_QUANTITY);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().placedDate(UPDATED_PLACED_DATE).quantity(UPDATED_QUANTITY);
        return payment;
    }
    ...
    void createPayment() throws Exception {
        ...
        assertThat(testPayment.getPlacedDate()).isEqualTo(DEFAULT_PLACED_DATE);
        assertThat(testPayment.getQuantity()).isEqualByComparingTo(DEFAULT_QUANTITY);
    }
    ...
    void putExistingPayment() throws Exception {
        ...
        updatedPayment.placedDate(UPDATED_PLACED_DATE).quantity(UPDATED_QUANTITY);
        ...
        Payment testPayment = paymentList.get(paymentList.size() - 1);
        assertThat(testPayment.getPlacedDate()).isEqualTo(UPDATED_PLACED_DATE);
        assertThat(testPayment.getQuantity()).isEqualByComparingTo(UPDATED_QUANTITY);
    }
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.quantity(UPDATED_QUANTITY);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.placedDate(UPDATED_PLACED_DATE).quantity(UPDATED_QUANTITY);
