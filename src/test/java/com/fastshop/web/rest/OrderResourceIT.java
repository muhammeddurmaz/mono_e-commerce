...
class OrderResourceIT {
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getTotalQuantity()).isEqualTo(DEFAULT_TOTAL_QUANTITY);
    ...
    void putExistingOrder() throws Exception {
        ...
        assertThat(testOrder.getTotalQuantity()).isEqualTo(UPDATED_TOTAL_QUANTITY);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.placedDate(UPDATED_PLACED_DATE).totalPrice(UPDATED_TOTAL_PRICE).status(UPDATED_STATUS);
